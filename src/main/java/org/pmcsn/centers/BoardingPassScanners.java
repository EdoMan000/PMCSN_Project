...
//        MsqEvent completion_event = new MsqEvent(time.current + service, true, EventType.BOARDING_PASS_SCANNERS_DONE, serverId);
...
//        events.sort(Comparator.comparing(MsqEvent::getTime));
        ...
        //generate a new completion event
        MsqEvent event = new MsqEvent(time.current + service, true, EventType.BOARDING_PASS_SCANNERS_DONE, serverId);
